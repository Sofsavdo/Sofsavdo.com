...
function RealBalancePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Hero balance card — same pattern as the dashboard's promoted "Mavjud balans": the
          withdrawable amount was previously one equally-weighted tile among five, with the actual
          payout CTA in a separate card below repeating the same number in prose. Now the number,
          the minimum-payout rule, and the action live in one place. */}
